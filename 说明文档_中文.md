...
编译以及烧录完固件之后还需要根据 Klipper 的 CAN 总线指引 [CANBUS - Klipper documentation](https://www.klipper3d.org/CANBUS.html#finding-the-canbus_uuid-for-new-micro-controllers) 完成 Klipper 配置.
