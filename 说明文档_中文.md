...
关于 Klipper 的文件（如 printer.cfg 等）放在了 这个仓库的 `firmware/Klipper` 文件夹中。请在文件夹中查阅 `说明文档_中文` 。
...
除了要修改 serial 的配置之外，你还需要根据 `Connect RPI uart_中文版.md` 说明文件配置树莓派，这个说明文件在 [github](https://github.com/FYSETC/FYSETC-SPIDER/blob/main/firmware/Klipper/) [gitee](https://gitee.com/fysetc/FYSETC-SPIDER/blob/main/firmware/Klipper/).
